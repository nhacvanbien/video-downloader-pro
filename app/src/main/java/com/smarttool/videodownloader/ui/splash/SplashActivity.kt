package com.smarttool.videodownloader.ui.splash
...
import com.smarttool.videodownloader.feature.splash.presentation.SplashScreen
...
class SplashActivity : BaseComposeActivity() {
    ...
    private fun startNextAct() {
        if (preferenceHelper.getBoolean(PreferenceHelper.PREF_SHOWED_START_LANGUAGE) == true) {
            if (preferenceHelper.getBoolean(PreferenceHelper.PREF_SHOWED_ONBOARDING) == true) {
                startActivity(
